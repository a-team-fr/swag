...
call "C:\Program Files (x86)\Microsoft Visual Studio\VS2017CommunityEdition\VC\Auxiliary\Build\vcvars64.bat" x64
...
@rem robocopy .\deps .\deploy\windows\deps /MIR
@rem robocopy .\src .\deploy\windows\src /MIR
@rem robocopy .\examples .\deploy\windows\examples /MIR
