...
var validateFileURL;
{
  ...
  validateFileURL = function validateFileURL(file, permissive) {
    if (file === undefined) {
      return;
    }
    ...
    try {
      ...
      if (permissive === undefined) {
          throw new Error('permissive parameter is not defined');
      }
...
function webViewerInitialized() {
  ...
  console.log("permissive : "+params.permissive)
    validateFileURL(file, params.permissive);
